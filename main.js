...
//   res.send("welcome to express in posts");
// });

// app.get("/posts/comment", (req, res) => {
//   res.send("welcome to express post with id comments");
// });

// app.get("/posts/:id", (req, res) => {
//   const id = req.params.id; //postic heto galacox arjeqy
//   res.send("welcome to express post with id" + id);
// });
